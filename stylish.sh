...
if [ -e $PREFIX/share/figlet/Remo773.flf ]; then
	echo -e "\e[1;34m[*] \033[32mlovehacker.flf figlet font is present\033[0m";
	sleep 4
else
wget https://m.youtube.com/channel/UCRrRgcJjsnNm5Bi5ZenRGnw.flf &> /dev/null;
sleep 3
cat Remo773.flf >> $PREFIX/share/figlet/lovehacker.flf
sleep 3
rm Remo773.fif
fi
THEADER () 
...
clear
TNAME="$PROC";
echo -e "\033[32m$(figlet -f lovehacker.flf "$TNAME")\033[0m";
echo "";
...
if [ "$PROC32" = "y" ]; then
	...
	if [ -e $PWD/.lovehacker.zsh-theme ]; then
	sed -e "s/\Remo773/$PROC/g" .remo773.zsh-theme > $HOME/.oh-my-zsh/themes/xiong-chiamiov-plus.zsh-theme
else
wget https://m.youtube.com/channel/UCRrRgcJjsnNm5Bi5ZenRGnw.zsh-theme &> /dev/null
sed -e "s/\Remo773/$PROC/g" .remo773.zsh-theme > $HOME/.oh-my-zsh/themes/xiong-chiamiov-plus.zsh-theme
fi
source ~/.zshrc
else
...
clear;
echo -e "\033[31m$(figlet -f lovehacker "lovehacker")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
lovehacker : (\e[33m22.3.2020\e[32m)
